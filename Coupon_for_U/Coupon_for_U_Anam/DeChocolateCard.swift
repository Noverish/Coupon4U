...
class DeChocolateCard: CardCell,CardCellProtocol {
    var coupon:Coupon?
    ...
    func setNowStamp(nowstamp:Int) {
        var imgList:[UIImageView] = [img01,img02,img03,img04,img05,img06,img07,img08,img09,img10,img11,img12]
        
        for i in 0...11{
            imgList[i].image = (i<nowstamp) ? UIImage(named: "DeChocolate_stamp") : UIImage(named: "DeChocolate_empty")
        }
    }
